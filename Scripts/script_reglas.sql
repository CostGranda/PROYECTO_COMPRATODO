...
ALTER TABLE PRODUCTO ADD CONSTRAINT NN_precio_producto CHECK (precio IS NOT NULL);
ALTER TABLE PRODUCTO ADD CONSTRAINT NN_existencia_real_producto CHECK (existencia_real IS NOT NULL);
ALTER TABLE PRODUCTO ADD CONSTRAINT NN_disponible_venta CHECK (disponible_venta IS NOT NULL);

--Tabla PRODUCTO_PEDIDO
ALTER TABLE PRODUCTO_PEDIDO ADD CONSTRAINT NN_cantidad_PRODUCTO_PEDIDO CHECK ( cantidad IS NOT NULL);
ALTER TABLE PRODUCTO_PEDIDO ADD CONSTRAINT NN_valor_unit_PRODUCTO_PED CHECK ( valor_unitario IS NOT NULL);

--Tabla PRODUCTO_VENTA
ALTER TABLE PRODUCTO_VENTA ADD CONSTRAINT NN_cantidad_PRODUCTO_VENTA CHECK ( cantidad IS NOT NULL);
...
ALTER TABLE VENTA ADD CONSTRAINT NN_valor_total_venta CHECK (valor_total IS NOT NULL );
